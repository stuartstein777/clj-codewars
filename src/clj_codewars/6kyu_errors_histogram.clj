(ns clj-codewars.6kyu-errors-histogram
  (:require [clojure.string :as str]))

;; Errors : histogram
; In a factory a printer prints labels for boxes. The printer uses colors which, for the sake of simplicity, are
...
; letter (error letters are sorted in alphabetical order) in a field of 2 characters, a white space, number of error
; for that letter in a field of 6, as many "*" as the number of errors for that letter and "\r".
;
