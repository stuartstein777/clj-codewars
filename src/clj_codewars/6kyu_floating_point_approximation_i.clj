(ns clj-codewars.6kyu-floating-point-approximation-i)
...
; This function involves the subtraction of a pair of similar numbers when x is near 0 and the results are
; significantly erroneous in this region. Using pow instead of sqrt doesn't give better results.
;
...
; https://en.wikipedia.org/wiki/Loss_of_significance#Workarounds
(defn fpa-i [x]
  (/ x (+ 1N (Math/sqrt (+ 1N x)))))