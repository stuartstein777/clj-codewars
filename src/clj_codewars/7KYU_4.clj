(ns clj-codewars.7KYU-4
  (:require [clojure.string :as str]
            [clj-codewars.handy-functions :as h])
...
;; GCD Sum
; Given the sum and gcd of two numbers, return those two numbers in ascending order. If the numbers do not exist,
; return -1, (or NULL in C, tuple (-1,-1) in C#, pair (-1,-1) in C++, array {-1,-1} in Java and Golang).
;
; For example:
