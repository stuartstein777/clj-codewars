(ns clj-codewars.6kyu-mutual-recursion)
...
;
; Let's use the Hofstadter Female and Male sequences to demonstrate this technique. You'll want to create two
; functions F and M such that the following equations are true:
;
;   F(0) = 1
;   M(0) = 0
;   F(n) = n - M(F(n - 1))
...
;
; Hofstadter Wikipedia Reference
