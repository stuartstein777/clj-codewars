...
;
; Then return a report as a string (underscores show spaces -- don't put them in your solution. They are there so you
; can see them and how many of them you need to have):
;
