(ns clj-codewars.6kyu-reach-me-and-sum-my-digits)
...
;   ....  - ..... = ...
;
; So the values of the differences between contiguous terms are cyclical and are repeated as the differences values
