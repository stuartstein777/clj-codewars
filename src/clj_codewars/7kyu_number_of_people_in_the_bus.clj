(ns clj-codewars.7kyu-number-of-people-in-the-bus)
...
; represent number of people get into bus (The first item) and number of people get off the bus (The second item) in a
; bus stop.
;
